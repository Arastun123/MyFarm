...
function ManageMilk({ route }) {
    const { id, operation_type, pendingId, defaultValue, target_table } = route.params;
    ...
    const [inputs, setInputs] = useState({
        ...
        morning: defaultValue ? defaultValue.morning : '',
        night: defaultValue ? defaultValue.night : '',
        total: defaultValue ? defaultValue.total : '',
        used_milk: defaultValue ? defaultValue.used_milk : '',
        sold_to: defaultValue ? defaultValue.sold_to : '',
        quantity: defaultValue ? defaultValue.quantity : '',
        total: defaultValue ? defaultValue.total : '',
        ...
        <>
            <View style={styles.container}>
                ...
                <View style={styles.radioButtonContainer}>
                    {operation_type === 'soldMilk/delete-soldMilk' || operation_type === 'milk/delete-milk' && userData.role === 'master_admin' && (
                        <>
                            <Button
                                text='Təsdiq et'
                    ...
                    {operation_type === 'soldMilk/update-soldMilk' || operation_type === 'milk/update-milk' && userData.role === 'master_admin' && (
                    ...
                    {operation_type !== '' || operation_type !== '' && userData.role !== 'master_admin' && (
                    ...
                    {defaultValue !== '' || operation_type === '' || operation_type === '' && (
                        <>
                            <Button
                                text='Təsdiq et'
                                onPress={addMilkReport}
